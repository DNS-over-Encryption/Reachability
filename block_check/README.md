# DoE Block Check
A tool for detecting DoE service reachability. It supports four encrypted DNS protocols, including DNS over TLS, DNS over HTTPS, DNS over QUIC, and DNS over HTTP/3.
...
```
./Block_Check -n 10 -i ./domain.txt -o ./result/ -t doh -p 443 -s true -a ipv4 -h h2 -m GET
```
...
```
./Block_Check -n 10 -i ./domain.txt -o ./result/ -t doh3 -p 443 -s true -a ipv6 -m GET
```
